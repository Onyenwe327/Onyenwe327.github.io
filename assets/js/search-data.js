...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "projects",
          description: "Some summaries of my work.",
          section: "Navigation",
          handler: () => {
          ...
          title: "repositories",
          description: "Summary for some of my public repos.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6A%6A%7A%68%30%31%30%33@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/jiajinzhang", "_blank");
        },
      },{
      id: 'light-theme',
